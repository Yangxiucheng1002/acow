...
#ifndef MATH_ACSLM_FIT_H_
#define MATH_ACSLM_FIT_H_
...
public:
	...
	///
	template<typename T>
	bool linearFit(const std::vector<typename T>& x,
			const std::vector<typename T>& y, bool isSaveFitYs = false) {
	...
	void polyfit(const std::vector<typename T>& x,
			const std::vector<typename T>& y, int poly_n, bool isSaveFitYs =
					true) {
...
private:
	...
	template<typename T>
	void gauss_solve(int n, std::vector<typename T>& A,
			std::vector<typename T>& x, std::vector<typename T>& b) {
